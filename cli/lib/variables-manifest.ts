...
export const VAR_MANIFEST: VarSpec[] = [
  ...
  },
  {
    ...
    note: 'Enables the qa-role:model:select Google Gemini endpoint discovery. Optional; missing key omits the provider from the catalog. Local only.',
  },
  {
    ...
    required: false,
    critical: false,
    obtainHint: 'Anthropic Console — https://console.anthropic.com.',
    note: 'Enables the qa-role:model:select Anthropic endpoint discovery. Optional; missing key omits the provider from the catalog. Local only.',
  },
  {
    name: 'OPENAI_API_KEY',
    destinations: ['local'],
    ...
    note: 'Enables the qa-role:model:select OpenAI endpoint discovery. Optional; missing key omits the provider from the catalog. Local only.',
  },
  {
    ...
    note: 'Enables the qa-role:model:select DeepSeek endpoint discovery. Optional; missing key omits the provider from the catalog. Local only.',
  },
  {
    name: 'KIMI_API_KEY',
    destinations: ['local'],
    ...
    note: 'Enables the qa-role:model:select Kimi/Moonshot endpoint discovery. Optional; missing key omits the provider from the catalog. Local only.',
  },
  {
    name: 'DBHUB_TYPE',
    destinations: ['local'],
